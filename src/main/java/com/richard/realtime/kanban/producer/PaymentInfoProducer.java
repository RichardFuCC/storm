package com.richard.realtime.kanban.producer;
import com.richard.realtime.kanban.domain.PaymentInfo;
...
public class PaymentInfoProducer {
    public static void main(String[] args){
        ...
        while (true){
            //3、发送数据
            kafkaProducer.send(new ProducerRecord<String, String>("richard",new PaymentInfo().random()));
            try {
                Thread.sleep(1000);
